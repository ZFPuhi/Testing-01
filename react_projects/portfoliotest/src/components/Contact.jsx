...
// PublicKey - Replace with the public key from Emailjs
// template_id - Replace with the template id from Emailjs
// service_id - Replace with the service id from Emailjs
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    .then (() => {
      setLoading(false);
      alert('Thank you for contacting me. I will reach back to you as soon as possible.');
      setForm({
        name: '',
        email: '',
        message: '',
      ...
      setLoading(false)
      console.log(error);
      alert('Oops I am not feeling well Mr. Stark')
    })
  }
